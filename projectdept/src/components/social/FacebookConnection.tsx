...
import { Facebook, User, Image, MessageCircle, Users, Calendar, RefreshCw, Unlink, CheckCircle, AlertCircle, Loader, Heart, Eye, ThumbsUp, Shield, Globe } from 'lucide-react';
...
export const FacebookConnection: React.FC<FacebookConnectionProps> = ({ onConnectionChange }) => {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      setError('Erro inesperado ao conectar com Facebook. Verifique se o domínio está configurado corretamente.');
    } finally {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs text-gray-500">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>Domínio: projdepl-hdse.vercel.app</span>
              </div>
              <p>Dados processados localmente e com segurança</p>
            </div>
          </div>
        </div>
      </Card>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="font-medium text-green-900">Facebook Conectado com Sucesso!</h3>
            <p className="text-sm text-green-800">
              Seus dados foram carregados e estão prontos para análise.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
            {connection.photos.slice(0, 12).map((photo) => (
              <motion.div
                ...
                className="aspect-square rounded-lg overflow-hidden bg-gray-200 group cursor-pointer relative"
              >
                <img
                  src={photo.source}
